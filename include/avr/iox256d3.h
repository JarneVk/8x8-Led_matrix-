...
{
    NVM_FUSES_WDPER_8CLK_gc = (0x00<<0),  /* 8 cycles (8ms @ 3.3V) */
    NVM_FUSES_WDPER_16CLK_gc = (0x01<<0),  /* 16 cycles (16ms @ 3.3V) */
    NVM_FUSES_WDPER_32CLK_gc = (0x02<<0),  /* 32 cycles (32ms @ 3.3V) */
    NVM_FUSES_WDPER_64CLK_gc = (0x03<<0),  /* 64 cycles (64ms @ 3.3V) */
    NVM_FUSES_WDPER_128CLK_gc = (0x04<<0),  /* 128 cycles (0.125s @ 3.3V) */
    NVM_FUSES_WDPER_256CLK_gc = (0x05<<0),  /* 256 cycles (0.25s @ 3.3V) */
    NVM_FUSES_WDPER_512CLK_gc = (0x06<<0),  /* 512 cycles (0.5s @ 3.3V) */
    NVM_FUSES_WDPER_1KCLK_gc = (0x07<<0),  /* 1K cycles (1s @ 3.3V) */
    NVM_FUSES_WDPER_2KCLK_gc = (0x08<<0),  /* 2K cycles (2s @ 3.3V) */
    NVM_FUSES_WDPER_4KCLK_gc = (0x09<<0),  /* 4K cycles (4s @ 3.3V) */
    NVM_FUSES_WDPER_8KCLK_gc = (0x0A<<0),  /* 8K cycles (8s @ 3.3V) */
} NVM_FUSES_WDPER_t;
